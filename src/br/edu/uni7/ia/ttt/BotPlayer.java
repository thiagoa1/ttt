...
//							choosenStateWinChance = childChance.winChance;
//							choosenStateDrawChance = childChance.drawChance;
//							// Ap�s escolhe o caminho com mais vit�rias
//						}
				...
				System.out.println("Possibilidade do estado: vit�ria=" + choosenStateWinChance + "% empate="
						+ choosenStateDrawChance + "% derrota=" + choosenStateLossChance + "%");
			} else {
				// TODO tratar para erro onde o estado atual n�o se encontra na �rvore
			}
		} else {
			// TODO Tratar quando o jogo j� est� finalizado
		}
		return choosenState;
	}
	...
	private void generateTree() {
		...
		if (!startPlayer) {
			// Para gerar a �rvore do segundo jogador
	...
	// Retorna a chance daquele n� ganhar o jogo
...
//			stateChances; // TODO chance do estado atual. acima � a chance dos filhos
		}
